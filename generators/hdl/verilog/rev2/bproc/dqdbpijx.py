...
vw = VerilogWriter(dqdbpijx_file, dim_list, num_links)
...
vw.writeLine("   input  signed[(WIDTH-1):0]")
vw.setIndentLevel("      ")
vw.writeCommaSep(vw.genColRowVector_1d("minvm_in"), lineSepElements=num_links)
###
...
vw.writeLine("   input  signed[(WIDTH-1):0]")
vw.setIndentLevel("       ")
vw.writeCommaSep(vw.jointIndexFormatStr(1, "tau_vec_in_R{j}"))
###
...
vw.writeLine("   output signed[(WIDTH-1):0]")
vw.setIndentLevel("       ")
vw.writeCommaSep(vw.jointIndexFormatStr(1, "minv_vec_out_R{j}"), last=True)
###
vw.writeLine("   );")
...
vw.writeLine("   wire signed[(WIDTH-1):0]")
vw.setIndentLevel("      ")
vw.writeCommaSep(xtdotminv.gen_xtdotminv_minvm_in(), lineSepElements=num_links, last=2)
###
